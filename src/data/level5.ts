...
export const LEVEL5_DATA: GameItem[] = [
  ...
  { id: 'human_body', nameRu: 'Тело человека', nameEn: 'Human Body', value: 36.6, displayValue: '36.6 °C', emoji: '🧑', imageUri: '', category: 'Биология', funFact: 'Нормальная температура здорового человека.' },
  { id: 'ice', nameRu: 'Лед', nameEn: 'Ice', value: 0, displayValue: '0 °C', emoji: '🧊', imageUri: '', category: 'Вещества', funFact: 'Точка замерзания пресной воды.' },
  { id: 'absolute_zero', nameRu: 'Абсолютный нуль', nameEn: 'Absolute Zero', value: -273.15, displayValue: '-273.15 °C', emoji: '❄️', imageUri: '', category: 'Физика', funFact: 'Минимально возможная температура.' },
  { id: 'dry_ice', nameRu: 'Сухой лед', nameEn: 'Dry Ice', value: -78.5, displayValue: '-78.5 °C', emoji: '💨', imageUri: '', category: 'Вещества', funFact: 'Твердый углекислый газ.' },
  ...
  { id: 'magma', nameRu: 'Магма', nameEn: 'Magma', value: 1200, displayValue: '1200 °C', emoji: '🌋', imageUri: '', category: 'Геология', funFact: 'Лава становится магмой под землей.' },
  { id: 'oven', nameRu: 'Духовка (макс)', nameEn: 'Oven', value: 250, displayValue: '250 °C', emoji: '🍳', imageUri: '', category: 'Быт', funFact: 'Стандартный максимум бытовой духовки.' },
  ...
  { id: 'candle_flame', nameRu: 'Пламя свечи', nameEn: 'Candle Flame', value: 1000, displayValue: '1000 °C', emoji: '🕯️', imageUri: '', category: 'Химия', funFact: 'Самая горячая часть пламени невидима.' },
  ...
  { id: 'lightning', nameRu: 'Молния', nameEn: 'Lightning', value: 30000, displayValue: '30 000 °C', emoji: '⚡', imageUri: '', category: 'Природа', funFact: 'В 5 раз горячее поверхности Солнца.' },
