...
export const LEVEL13_DATA: GameItem[] = [
  ...
  },
  {
    ...
    category: 'Сумчатые',
    funFact: 'Крошечный детёныш рождается недоразвитым и проводит в сумке матери около восьми месяцев, прежде чем окончательно её покинуть.'
  },
  {
    id: 'rabbit',
    nameRu: 'Кролик',
  ...
  },
  {
    ...
    imageUri: '',
    category: 'Млекопитающие',
    funFact: 'Самка способна забеременеть уже через несколько часов после родов, а детёныши открывают глаза примерно на 14-й день жизни.'
  }
];
