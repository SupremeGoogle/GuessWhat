...
export const LEVEL7_DATA: GameItem[] = [
  {
    ...
    displayValue: '$0.1',
    emoji: '🔥',
    imageUri: '/images/matchbox_1786534027561.jpg',
    category: 'Предметы',
  ...
  },
  {
    ...
    emoji: '🏎️',
    imageUri: '/images/ferrari_1786532353764.jpg',
    category: 'Транспорт',
  ...
  },
  {
    ...
    emoji: '🖼️',
    imageUri: '/images/mona_lisa_1786534057212.jpg',
    category: 'Искусство',
  ...
  },
  {
    ...
    emoji: '🛰️',
    imageUri: '/images/iss_cost_1786534068449.jpg',
    category: 'Космос',
    funFact: 'Самый дорогой объект, когда-либо созданный человечеством.'
  },
  { id: 'matchstick', nameRu: 'Одна спичка', nameEn: 'Matchstick', value: 0.01, displayValue: '$0.01', emoji: '🔥', imageUri: '/images/matchstick_1786534071588.jpg', category: 'Вещи', funFact: 'Спички были изобретены после зажигалок.' },
  ...
  { id: 'new_car', nameRu: 'Новый автомобиль', nameEn: 'New Car', value: 40000, displayValue: '$40,000', emoji: '🚗', imageUri: '', category: 'Транспорт', funFact: 'Теряет 20% стоимости при выезде из салона.' },
