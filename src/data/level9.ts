...
export const LEVEL9_DATA: GameItem[] = [
  ...
  { id: 'thunderclap', nameRu: 'Раскат грома', nameEn: 'Thunder', value: 120, displayValue: '120 дБ', emoji: '⛈️', imageUri: '/images/lightning_1786533903072.jpg', category: 'Природа', funFact: 'Гром это звук от расширяющегося воздуха.' },
